...
import { TEXT_AREA_DEFAULTS } from "~/constants";

const {
  rows = TEXT_AREA_DEFAULTS.ROWS,
  resize = TEXT_AREA_DEFAULTS.RESIZE,
  placeholder = TEXT_AREA_DEFAULTS.PLACEHOLDER,
  disabled = TEXT_AREA_DEFAULTS.DISABLED,
  required = TEXT_AREA_DEFAULTS.REQUIRED,
  maxlength = TEXT_AREA_DEFAULTS.MAXLENGTH,
...
<template>
  <div class="relative">
    ...
    <div
      v-if="hasMaxLength"
      class="absolute bottom-2 right-3 text-[11px] color-[var(--color-dark-gray)] pointer-events-none bg-white/90 px-1 py-[2px] rounded-sm"
    >
